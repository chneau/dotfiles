...
alias igit='git config --global user.email "charles63500@gmail.com"; git config --global user.name "chneau"; git config --global url.ssh://git@github.com/.insteadOf https://github.com/'
...
alias nowtime=now
alias npmig='npm i -g ungit npm-check-updates npm nodemon prettier'
...
alias root='\sudo \su'
alias sop='serveo'
alias sshnew='ssh-keygen -t rsa -b 2048'
