...
alias igit='git config --global user.email "charles63500@gmail.com"; git config --global user.name "chneau"; git config --global url.ssh://git@github.com/.insteadOf https://github.com/; git config --global core.autocrlf true; git config --global core.safecrlf false; git config --global merge.ff false; git config --global pull.ff true; git config --global core.whitespace blank-at-eol,blank-at-eof,space-before-tab,cr-at-eol; git config --global fetch.prune true; git config --global pull.rebase true'
...
alias wsldocker='wsl --user root service docker start'
