...
alias updateall='sudo apt -y autoremove && sudo apt -yf install && sudo apt -y update && sudo apt-get -y upgrade && sudo apt -y dist-upgrade'
...
alias npmu="npm-check-updates -u && npm install && npm update"
